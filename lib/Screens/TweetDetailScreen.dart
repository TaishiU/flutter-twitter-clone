                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text(
                              '${widget.tweet.timestamp.toDate().year.toString()}/${widget.tweet.timestamp.toDate().month.toString()}/${widget.tweet.timestamp.toDate().day.toString()}',
                              style: TextStyle(
                                fontSize: 14,
                                color: Colors.grey,
                              ),
